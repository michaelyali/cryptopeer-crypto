...
describe('ChaCha20', () => {
  ...
  describe('getNonceIncrement', () => {
    ...
    it('should return incremented nonce buffer from buffer', () => {
      const nonce = ChaCha20.getNonce();
      const inonce = ChaCha20.getNonceIncrement(nonce);
    ...
    it('should return incremented nonce buffer from encoded string', () => {
      ...
      let inonce = ChaCha20.getNonceIncrement(nonceString);
  ...
  describe('getNonceIncrementAsync', () => {
    ...
    it('should return incremented nonce buffer from encoded string, 1/2', (done) => {
      const nonce = ChaCha20.getNonce();
      const nonceString = nonce.toString('base64');
  ...
  describe('getKey', () => {
    ...
    it('should return a key with secret, salt and encoding params', () => {
      const key = ChaCha20.getKey(new Buffer('SuperSecretKey').toString('hex'), 'hex', 'SuperRandomSalt');
  ...
  const plainText = 'Test message from Alice';
  const nonce = new Buffer('SUxfjOvrEyA=', 'base64');
  const key = new Buffer('GXu9CCjQHiQm5MUzdmxby6Nec2lPZzLiDY8OvygUg/c=', 'base64');
  const encrypted = 'padkGdmrymqLRNruHWrf9ArfqZEP4dR+s42EPZK/ojoQQGEMe1Zr';
  ...
  describe('encrypt', () => {
    ...
    it('should encrypt with plain buffer', () => {
      const enc = ChaCha20.encrypt(new Buffer(plainText, 'utf8'), nonce, key);
  ...
  describe('decrypt', () => {
    ...
    it('should decrypt with cipher buffer', () => {
      const dec = ChaCha20.decrypt(new Buffer(encrypted, 'base64'), nonce, key);
